...
import myPic2 from '../assets/dp2.jpg'
    ...
    <div className=" p-5 bg-gray-900 text-white  mx-auto py-10  ">
      <div className="flex lg:space-x-5 flex-col lg:flex-row-reverse  items-center justify-center">
        ...
        <div data-aos="fade-right"
          ...
          <p className="py-6">Hello! I'm Mushfiq Alam Sami, from Dhaka, Bangladesh. <br />  I am dedicated to learning and mastering new technologies, and coding has become my true passion. <br /> I invest a significant amount of time in staying up-to-date with the latest trends and honing my skills.
